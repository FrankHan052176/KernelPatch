...
static const char user_rc_data[] = { //
    "\n"
    "on early-init\n"
    "    exec -- " SUPERCMD " suu exec " USER_INIT_SH_PATH " %s early-init\n"
    "on init\n"
    "    exec -- " SUPERCMD " suu exec " USER_INIT_SH_PATH " %s init\n"
    "on late-init\n"
    "    exec -- " SUPERCMD " suu exec " USER_INIT_SH_PATH " %s late-init\n"
    "on post-fs-data\n"
    "    exec -- " SUPERCMD " suu exec " USER_INIT_SH_PATH " %s post-fs-data\n"
    "on nonencrypted\n"
    "    exec -- " SUPERCMD " suu exec " USER_INIT_SH_PATH " %s services\n"
    "on property:vold.decrypt=trigger_restart_framework\n"
    "    exec -- " SUPERCMD " suu exec " USER_INIT_SH_PATH " %s services\n"
    "on property:sys.boot_completed=1\n"
    "    exec -- " SUPERCMD " suu exec " USER_INIT_SH_PATH " %s boot-completed\n"
    "    rm " REPLACE_RC_FILE "\n"
    "    rm " USER_INIT_SH_PATH "\n"
    "    exec -- " SUPERCMD " suu -c \"mv -f " DEV_LOG_DIR " " AP_LOG_DIR "\"\n"
    ""
};
